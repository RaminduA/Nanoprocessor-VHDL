...
HD_PWD='C:/Users/RAMINDU/Desktop/2nd sem/Computer Organization and Digital Design/Week 10/Lab 9-10/Nanoprocessor/4-bit Add_Subtract unit/Adder+Subtractor/ASU_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ASU_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ASU_4bit.tcl
