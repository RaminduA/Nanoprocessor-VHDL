...
read_vhdl -library xil_defaultlib {{C:/Users/RAMINDU/Desktop/2nd sem/Computer Organization and Digital Design/Week 10/Lab 9-10/Nanoprocessor/4-bit Add_Subtract unit/Half Addrr/Half_Adder.srcs/sources_1/new/HA.vhd}}
...
synth_design -top HA -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef HA.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file HA_utilization_synth.rpt -pb HA_utilization_synth.pb"
