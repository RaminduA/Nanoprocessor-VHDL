...
HD_PWD='C:/Users/RAMINDU/Desktop/2nd sem/Computer Organization and Digital Design/Week 10/Lab 9-10/Nanoprocessor/4-bit Add_Subtract unit/Half Addrr/Half_Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HA.tcl -notrace
