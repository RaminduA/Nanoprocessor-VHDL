...
HD_PWD='C:/Users/RAMINDU/Desktop/2nd sem/Computer Organization and Digital Design/Week 10/Lab 9-10/Nanoprocessor/4-bit Add_Subtract unit/Ripple Carry Adder/RCA_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RCA_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RCA_4bit.tcl
