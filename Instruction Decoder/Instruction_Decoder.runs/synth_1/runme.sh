...
HD_PWD='C:/Users/RAMINDU/Desktop/2nd sem/Computer Organization and Digital Design/Week 10/Lab 9-10/Nanoprocessor/Instruction Decoder/Instruction_Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ID.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ID.tcl
