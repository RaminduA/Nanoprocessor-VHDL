...
HD_PWD='C:/Users/RAMINDU/Desktop/2nd sem/Computer Organization and Digital Design/Week 10/Lab 9-10/Nanoprocessor/Register Bank/Register_Bank.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder_3_to_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decoder_3_to_8.tcl
