...
HD_PWD='C:/Users/RAMINDU/Desktop/2nd sem/Computer Organization and Digital Design/Week 10/Lab 9-10/Nanoprocessor/Register Bank/Register_Bank.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder_3_to_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Decoder_3_to_8.tcl -notrace
