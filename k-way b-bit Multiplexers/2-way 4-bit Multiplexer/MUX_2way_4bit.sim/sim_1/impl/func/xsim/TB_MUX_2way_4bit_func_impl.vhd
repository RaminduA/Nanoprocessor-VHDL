...
--               Digital Design/Week 10/Lab 9-10/Nanoprocessor/k-way b-bit Multiplexers/2-way 4-bit
--               Multiplexer/MUX_2way_4bit.sim/sim_1/impl/func/xsim/TB_MUX_2way_4bit_func_impl.vhd}
...
entity MUX_2way_4bit is
  ...
  attribute NotValidForBitStream of MUX_2way_4bit : entity is true;
  attribute ECO_CHECKSUM : string;
  attribute ECO_CHECKSUM of MUX_2way_4bit : entity is "c7330f1b";
end MUX_2way_4bit;

architecture STRUCTURE of MUX_2way_4bit is
  ...
  attribute SOFT_HLUTNM of \Q_OBUF[2]_inst_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Q_OBUF[3]_inst_i_1\ : label is "soft_lutpair1";
begin
...
\Q_OBUF[3]_inst_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
